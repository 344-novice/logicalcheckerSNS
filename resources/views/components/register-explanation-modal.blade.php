<div id="register-explanation-modal" role="dialog" aria-modal="true" aria-labelledby="modal-title" class="fixed flex inset-0 items-center justify-center bg-black bg-opacity-50 z-50 hidden">
    <div class="flex flex-col p-6 max-w-3xl min-w-[400px] min-h-[200px] bg-white rounded-lg shadow-lg">
        ...
        <ul class="list-disc list-inside space-y-2 text-gray-700">
            ...
            <li>メールアドレスはダミーでも問題ありませんが、@と.の入っていない場合は弾かれます</li>
